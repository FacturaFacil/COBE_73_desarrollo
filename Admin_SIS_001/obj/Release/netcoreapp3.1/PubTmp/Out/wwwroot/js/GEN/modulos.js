...
$(document).on('change', '#txtId', function () {
    ...
    $.ajax({
        //  async: false,
        method: "POST",
        url: "/Admin/GEN_Modulos/ExisteClave",
...
function cargarDataTable() {
    dataTable = $('#tblModulos').DataTable({
        "ajax": {
            "url": "/Admin/GEN_Modulos/GetAll",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            },
            {
                "data": "id", "render": function (data) {
                    return `<div class="text-center">
                            <p class="mb-0">
                                <a href='/Admin/GEN_Modulos/Edit/${data}' class="btn btn-success btn-circle text-white" ><i class="fa fa-edit btnEditar"></i></a>
                                <a onclick=Delete('/Admin/GEN_Modulos/Delete/${data}') class="btn btn-danger btn-circle text-white"><i class="fa fa-trash btnEliminar"></i></a>
                            </p>
...
function ClicTabla() {
    $("#tblModulos tbody").on("click", ".cb_activo", function (e) {

        var row = $('#tblModulo').DataTable().row($(this).parents('tr')).data();
       
            $.ajax({
                //  async: false,
                type: "POST",
                url: "/Admin/GEN_Modulos/CambiaEstatus",
                data: { id: row.id },
                dataType: "json",
                beforeSend: function () {
                },
