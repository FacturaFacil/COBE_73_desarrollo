...
function agregarImpuesto(imp)
{
    ...
    if (imp == "iva_tras") {
        var ivaTrasTr = `<tr>
                     <td>002</td>
                     <td>IVA</td>
                     <td> <select asp-for="Producto.Clase" class="form-control form-control-sm" id="cb_Factor">
                             <option value="Tasa">Tasa</option>
                             <option value="Exento">Exénto</option>
                          </select>
                    </td>                    
                     <td><select asp-for="Producto.Clase" class="form-control form-control-sm" id="cb_valor">
