...
$(document).on('change', '#txtId', function () {
        $.ajax({
            //  async: false,
            method: "POST",
            url: "/Cliente/INV_Lineas/ExisteFolio",
            ...
            },
            {
                "data": "id", "render": function (data) {
                    return `<div class="text-center">
                            <p class="mb-0">
                                <a href='/Cliente/INV_Lineas/Edit/${data}' class="btn btn-success btn-circle text-white" ><i class="fa fa-edit btnEditar"></i></a>
                                <a onclick=Delete('/Cliente/INV_Lineas/Delete/${data}') class="btn btn-danger btn-circle text-white"><i class="fa fa-trash btnEliminar"></i></a>
                            </p>
...
function ClicTabla() {
    $("#tblLineas tbody").on("click", ".cb_activo", function (e) {

        var row = $('#tblLineas').DataTable().row($(this).parents('tr')).data();

        $.ajax({
            //  async: false,
            type: "POST",
            url: "/Cliente/INV_Lineas/CambiaEstatus",
            data: { id: row.id },
            dataType: "json",
            beforeSend: function () {
            },
